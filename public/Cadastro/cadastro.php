	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-50 p-b-50">
				<form class="login100-form validate-form" method="post" action="../../logic/fazer_cadastro.php">
					...
					<?php if(isset($_GET['status']) && $_GET['status'] == 0){?>
						...
						<div class="alert alert-danger" role="alert" style="margin-top: -30px; width: 100%">
							Email já cadastrado! <br> <a href="../login/login.html">Faça o seu loggin</a>
						</div>

					<?php } else if(isset($_GET['status']) && $_GET['status'] == 1){?>
						<div class="alert alert-danger" role="alert" style="margin-top: -30px; width: 100%">
							Cadastro efetuado com sucesso! <br> <a href="../login/login.html">Loggar</a>
						</div>
					<?php }?>
