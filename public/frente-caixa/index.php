            ...
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="../relatorios/dashboard.html" class="nav_link">
                        ...
                        <span class="nav_name">Relatório</span>
                    </a>
        ...
        <div class="row">
            ...
            <div class="card border-dark text-center text-white col-xl-3 col-lg-12 col-md-12 col-sm-12 mt-4 color">
                ...
                <div class="card-body text-white align-middle">
                    ...
                    <p><button type="button" class="btn btn-info col-lg-12">Cartão de Débito</button>
                    </p>
                    <p><button type="button" class="btn btn-dark col-lg-12">Cartão de Crédito</button>
                    </p>
